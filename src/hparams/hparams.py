...
file_handler = logging.FileHandler("hparam.log")
...
def main(cfg: DictConfig):
    ...
    try:
        with mlflow.start_run(log_system_metrics=True, nested=True):
            ...
            cv_scores = cross_val_score(pipe, X_test, y_test, cv=5, scoring="roc_auc")
